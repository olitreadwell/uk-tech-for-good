...
def resolve(r, names, namemap):
    ...
    reference uses a shortened or differently-cased form (e.g. "Open Data
    Institute" -> "Open Data Institute (ODI)"). Returns None if no
...
def render_guide(
    ...
    lines = []
    lines.append("# UK Tech-for-Good Guide")
    lines.append("")
    lines.append(
        "This is a living directory of UK organisations, projects, "
    ...
    lines.append("")
    lines.append(
        "**Who this is for:** people looking for UK tech-for-good groups to "
