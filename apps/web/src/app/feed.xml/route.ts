...
export async function GET() {
  ...
  const newest = [...entries]
    ...
    .slice(0, 20);
  const base = 'https://olitreadwell.github.io/uk-tech-for-good';
  ...
  return new Response(
    `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>UK Tech-for-Good</title><link>${base}</link><description>Recently updated organisations</description>${items}</channel></rss>`,
