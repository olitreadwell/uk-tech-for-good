    ...
    <footer className="mt-auto border-t border-border bg-surface-alt">
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="grid gap-6 sm:grid-cols-4">
          <div>
            <h4 className="text-sm font-semibold">UK Tech-for-Good</h4>
            <p className="mt-1 text-xs text-text-muted">
              Community-maintained directory of UK organisations using technology for public good.{' '}
              <a
          ...
          <div>
            ...
            <ul className="mt-1 space-y-1 text-xs">
              ...
              <li>
                <a
                  href="https://github.com/olitreadwell/uk-tech-for-good"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <a
                  href="https://github.com/olitreadwell/uk-tech-for-good/blob/main/CONTRIBUTING.md"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-text-muted hover:text-text"
                >
          ...
          <div>
            ...
            <ul className="mt-1 space-y-1 text-xs">
              <li>
                <a
                  href="https://raw.githubusercontent.com/olitreadwell/uk-tech-for-good/main/data/exports/entries.json"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-text-muted hover:text-text"
                >
              ...
              <li>
                <a
                  href="https://raw.githubusercontent.com/olitreadwell/uk-tech-for-good/main/data/exports/entries.csv"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-text-muted hover:text-text"
                >
        ...
        <p className="mt-6 text-center text-xs text-text-muted">
          Updated: {new Date().toISOString().slice(0, 10)} · United Kingdom
        </p>
      </div>
    </footer>
  );
