  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      <Section
        ...
        linkLabel="Join"
        empty="No communities listed yet. Know an active UK tech-for-good Slack or Discord? Suggest it on GitHub."
      />
      ...
      <section className="mt-10">
        ...
        <div className="mt-3 flex gap-3">
          <a
            href="https://github.com/olitreadwell/uk-tech-for-good/issues/new?template=add-entry.yml"
            target="_blank"
