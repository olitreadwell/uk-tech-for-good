...
```yaml
source: "orgname.org.uk homepage, verified 2026-09-23"
```
...
```
feat: add Open Data Institute entry

- Added a new entry for the Open Data Institute in the open data
  domain, verified against theodi.org.
```
